...
library(rootSolve)
path.dat <- "/nas/longleaf/home/haolin/adane/s6/data/"
path.results <- "/nas/longleaf/home/haolin/adane/s6/results/"

## simulation setting ##

n=2000
ntilde = 270
beta1 = matrix(c(0.5, 0.5), nrow=2)
